 ...
 */
public class DeathPeriodRecord extends PeriodRecord{
	private List<Double> NumDeathPerMillions =new ArrayList<>();
	 ...
	 */
	public DeathPeriodRecord(String country, Period period) {
		super(country,period);
		this.NumDeathPerMillions = DataAnalysis.getDeathPerPeriod("COVID_Dataset_v1.0.csv" , country, period);
	}
    ...
    public final List<Double> getNumDeathPerMillions() {
    	return this.NumDeathPerMillions;
    }
}